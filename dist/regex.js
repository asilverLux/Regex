...
const SECOND_BOUNDARY_REPLACEMENTS = {
    jr: ' junior',
    jnr: 'junior',
    ste: 'suite',
    suit: 'suite',
...
const EXACT_MATCH_REPLACEMENTS = {
...
const exactMatchReplace = (supplierRoom, Match_Replacements) => {
    return Match_Replacements[supplierRoom] ?? supplierRoom;
};
const replaceNumericalWords = (supplierRoom) => {
...
const regexReduceReplace = (supplierRoom, replacements, boundary = false, remove = false) => {
...
const removeSpaces = (supplierRoom) => {
    // removes any extra spaces
    return supplierRoom.replace(/\s+/g, ' ').trim();
};
const formatRoomString = (supplierRoom) => {
...
const formatRoomStringExpediaDouble = (supplierRoom) => {
    // lowercase and latinise before we start
    const lowercase = supplierRoom.toLowerCase();
    const latinised = latinise(lowercase);
    // replace numbers and known special characters, removing any other special characters
...
const formatRoomString2 = (supplierRoom) => {
    // lowercase and latinise before we start
    const lowercase = supplierRoom.toLowerCase();
    const latinised = latinise(lowercase);
    // replace numbers and known special characters, removing any other special characters
...
const formatRoomStringExpedia2 = (supplierRoom) => {
    // lowercase and latinise before we start
    const lowercase = supplierRoom.toLowerCase();
    const latinised = latinise(lowercase);
    // replace numbers and known special characters, removing any other special characters
...
const formatRoomStringExpediaTWIN = (supplierRoom) => {
    // lowercase and latinise before we start
    const lowercase = supplierRoom.toLowerCase();
    const latinised = latinise(lowercase);
    // replace numbers and known special characters, removing any other special characters
...
const formatRoomString3 = (supplierRoom) => {
    // lowercase and latinise before we start
    const lowercase = supplierRoom.toLowerCase();
    const latinised = latinise(lowercase);
    // replace numbers and known special characters, removing any other special characters
...
const containsAllWords = (masterWords, childWords) => {
...
//1st
const verifyRoomString1 = (supplierRoomA, supplierRoomB) => {
...
//2nd
const verifyRoomString2 = (supplierRoomA, supplierRoomB) => {
    if (!supplierRoomA || !supplierRoomB) {
        return false;
    }
...
//3rd
const verifyRoomString3 = (supplierRoomA, supplierRoomB) => {
    if (!supplierRoomA || !supplierRoomB) {
        return false;
    }
...
export const verifyRoomString = (supplierRoomA, supplierRoomB) => {
    if (!supplierRoomA || !supplierRoomB) {
        return false;
    }
...
export const processRoomStrings = (eps_room, supplierroom) => {
